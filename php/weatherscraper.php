...
bootstrap-theme.min.css">	
    ...
    <style>
      ...
      .container {
        background-image: url("weatherwallpaper.jpg");
        width: 100%;
        height: 100%;
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3 center">
            <h1 class="center white">Weather Dictator</h1>
            ...
            <div id="fail" class="alert alert-danger">Could not find any data for your city. Please try again!</div>
